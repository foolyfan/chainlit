...
const darkTheme = (
  ...
  createTheme({
    typography: {
      fontSize: fontSize ? fontSize : typography.fontSize,
      fontFamily: fontFamily ? fontFamily : typography.fontFamily
    },
    components,
    shape,
...
const makeTheme = (
  ...
  variant === 'dark'
    ? darkTheme(fontFamily, fontSize, breakpoints)
    : lightTheme(fontFamily, fontSize, breakpoints);
